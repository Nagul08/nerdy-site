  ...
  return (
    <section id="contact" className="py-8 scroll-mt-20 font-mono">
      ...
      <div className="mb-6 pb-3 border-b border-[#1C2030]">
        <div className="text-xs text-accent mb-1">// INBOX & OPPORTUNITIES</div>
        <h2 className="text-2xl font-extrabold text-[#F8FAFC] tracking-tight">
          Get in Touch
        </h2>
      </div>

      <div className="frosted-glass rounded-2xl p-6 sm:p-8 transition-all duration-300">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          <div className="lg:col-span-5 flex flex-col justify-between">
            <div>
              ...
              <div className="space-y-3 text-xs">
                <div className="bg-[#101422] p-3 rounded border border-[#1f263d]">
                  <div className="text-[#64748B] text-[11px]">DIRECT EMAIL</div>
                  <a
                    href="mailto:sivphax08@gmail.com"
                    className="text-accent hover:underline font-medium text-sm mt-0.5 inline-block"
                  >
                    sivphax08@gmail.com
                  </a>
                </div>
          ...
          <div className="lg:col-span-7">
            {transmitSuccess ? (
              <div className="bg-[#101422] border border-[#10B981]/40 rounded-lg p-6 text-center space-y-3">
                ...
                <p className="text-xs text-[#94A3B8] max-w-sm mx-auto">
                  ...
                  <strong className="text-accent">sivphax08@gmail.com</strong>.
                </p>
                <button
              ...
              <form onSubmit={handleSubmit} className="space-y-4 text-xs">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full bg-[#101322] border border-[#1f253d] focus:border-accent rounded px-3 py-2.5 text-[#F8FAFC] outline-none transition-colors"
                    />
                  </div>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full bg-[#101322] border border-[#1f253d] focus:border-accent rounded px-3 py-2.5 text-[#F8FAFC] outline-none transition-colors resize-none"
                  />
                </div>
                ...
                <button
                  ...
                  className="w-full py-2.5 rounded bg-accent hover:opacity-90 disabled:opacity-50 text-[#08090C] font-bold flex items-center justify-center gap-2 transition-all cursor-pointer shadow-lg accent-box-glow"
                >
