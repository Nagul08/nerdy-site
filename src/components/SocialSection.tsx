  ...
  return (
    <section id="social" className="py-8 scroll-mt-20 font-mono">
      ...
      <div className="mb-6 pb-3 border-b border-[#1C2030]">
        <div className="text-xs text-accent mb-1">// CONNECT & COLLABORATE</div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        {SOCIAL_LINKS.map((link) => {
          ...
          return (
            <div
              key={link.id}
              className="frosted-glass hover:border-accent/60 rounded-xl p-4 transition-all duration-200 flex items-center justify-between group"
            >
              <a
                href={link.url}
                target="_blank"
              ...
              >
                <div className="p-2 rounded-md bg-[#101422] border border-[#1f263d] group-hover:border-accent transition-colors">
                  {iconComponents[link.icon] || <ExternalLink className="w-4 h-4" />}
                </div>

                <div className="truncate">
                  <div className="flex items-center space-x-2">
                    <span className="text-sm font-bold text-[#F8FAFC] group-hover:text-accent transition-colors">
                      {link.platform}
                    </span>
              ...
              <div className="flex items-center space-x-1.5 ml-2">
                <button
                  ...
                  className="p-1.5 text-[#64748B] hover:text-accent hover:bg-[#101422] rounded border border-transparent hover:border-[#1f263d] transition-colors cursor-pointer"
                  title="Copy handle"
                >
                  {isCopied ? (
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="p-1.5 text-[#64748B] hover:text-accent hover:bg-[#101422] rounded border border-transparent hover:border-[#1f263d] transition-colors"
